...
const getAllProjects = require("../controllers/projectController").getAllProjects;
const getSingleProject = require("../controllers/projectController").getSingleProject;
const addMultipleProjects = require("../controllers/projectController").addMultipleProjects;
